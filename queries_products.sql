...
INSERT INTO products(name, price, can_be_returned)
    VALUES ('Coffee Brewing Machine', 149.99, FALSE);
...
-- Display only the products that have a price 
-- in between 22.50 and 99.99.
SELECT name
    FROM products
...
-- Because of the sale, everything that costs less than $25 
-- has sold out. Remove all products whose price meets this criteria.
DELETE
    FROM products
    WHERE price < 25;
